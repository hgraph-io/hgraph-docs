...
Each template includes a `README` with specific installation instructions and configuration details. We recommend following the `README` in your selected template repository for complete setup guidance.